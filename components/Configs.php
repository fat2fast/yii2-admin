 ...
 *
 * ```
 * Yii::$container->set('fat2fast\admin\components\Configs',[
 *     'db' => 'customDb',
 *     'menuTable' => 'admin_menu',
 * ]);
 * ```
...
class Configs extends \fat2fast\admin\BaseObject
{
    const CACHE_TAG = 'fat2fast.admin';
    ...
    public static function instance()
    {
        if (self::$_instance === null) {
            $type = ArrayHelper::getValue(Yii::$app->params, 'fat2fast.admin.configs', []);
